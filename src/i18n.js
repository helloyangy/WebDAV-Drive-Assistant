...
const MESSAGES = {
  "zh-CN": {
    ...
    "aiBackup.mode": "模式",
    "aiBackup.mode.off": "关闭",
    "aiBackup.mode.ask": "询问",
    "aiBackup.mode.auto": "自动",
    "aiBackup.drive": "备份账号",
    "aiBackup.drive.current": "当前网盘",
    "aiBackup.driveHelp": "选择备份使用的账号",
    "aiBackup.customFolder": "备份目录",
    "aiBackup.customFolder.placeholder": "默认 /AI-Backups",
    "aiBackup.blockedTypes": "禁止类型",
    "aiBackup.blockedTypesHelp": "例如 zip, exe",
    "aiBackup.blockedSites": "禁用网站",
    ...
    "dialog.clearCache.message": "将清空已缓存的预览和下载内容。",
    ...
    "preview.loading": "正在加载预览内容...",
    "preview.largeHint": "文件较大（{size}），预览可能需要较长时间，可随时取消。",
    "preview.loaded": "已加载 {loaded}",
    "preview.loadedOfTotal": "已加载 {loaded} / {total}",
    "preview.cancelLoad": "取消加载",
    "preview.canceled": "已取消预览加载",
    "preview.backgroundLoading": "预览加载中...",
    "preview.backgroundReady": "预览已就绪",
  ...
  en: {
    ...
    "aiBackup.mode": "Mode",
    "aiBackup.mode.off": "Off",
    "aiBackup.mode.ask": "Ask",
    "aiBackup.mode.auto": "Auto",
    "aiBackup.drive": "Account",
    "aiBackup.drive.current": "Current drive",
    "aiBackup.driveHelp": "Choose the backup account",
    "aiBackup.customFolder": "Folder",
    "aiBackup.customFolder.placeholder": "Default /AI-Backups",
    "aiBackup.blockedTypes": "Blocked types",
    "aiBackup.blockedTypesHelp": "e.g. zip, exe",
    ...
    "ui.layout": "Layout",
    "ui.preview": "Preview",
    "ui.previewProgress": "Preview progress",
    "ui.enter": "Enter",
    ...
    "preview.largeHint": "Large file ({size}). Preview may take a while. You can cancel anytime.",
    "preview.loaded": "Loaded {loaded}",
    "preview.loadedOfTotal": "Loaded {loaded} / {total}",
    "preview.cancelLoad": "Cancel loading",
    "preview.canceled": "Preview loading canceled",
    "preview.backgroundLoading": "Loading preview...",
    "preview.backgroundReady": "Preview ready",
