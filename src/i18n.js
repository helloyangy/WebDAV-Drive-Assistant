...
const MESSAGES = {
  "zh-CN": {
    ...
    "aiBackup.drive": "备份网盘",
    "aiBackup.drive.current": "当前网盘（跟随左侧选中账号）",
    "aiBackup.driveHelp": "选择 AI 备份上传到哪个网盘账号",
  ...
  en: {
    ...
    "aiBackup.drive": "Backup drive",
    "aiBackup.drive.current": "Current drive (follow selected account)",
    "aiBackup.driveHelp": "Choose which account to store AI backups",
